...
namespace powe
{
	...
	public:
		...
		virtual void InternalCreate(RawByte* , WorldEntity&, EntityID) {}
		virtual void InternalDestroy(RawByte*, WorldEntity&, EntityID) {}
	...
	public:
		...
		void InternalCreate(RawByte* source, WorldEntity&, EntityID) final;
		void InternalDestroy(RawByte* source, WorldEntity&, EntityID) final;
		[[nodiscard]] SizeType GetSize() const override;

	protected:

		virtual void OnDestroy(WorldEntity&, EntityID) {}
		virtual void OnCreate(WorldEntity&,EntityID) {}
		virtual void OnMove(WorldEntity&,EntityID) {}
	...
	template <typename T>
	void Component<T>::InternalCreate(RawByte* source, WorldEntity& worldEntity, EntityID gameObjectId)
	{
		reinterpret_cast<T*>(source)->OnCreate(worldEntity, gameObjectId);
	}

	template <typename T>
	void Component<T>::InternalDestroy(RawByte* source, WorldEntity& worldEntity, EntityID gameObjectId)
	{
