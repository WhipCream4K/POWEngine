...
void powe::WorldEntity::RegisterGameObject(EntityID id)
{
...
powe::EntityID powe::WorldEntity::GetNewEntityID()
{
    return m_GameObjectCounter++;
}

powe::EntityID powe::WorldEntity::CreateNewEntity()
{
    const EntityID newID{GetNewEntityID()};
    RegisterGameObject(newID);
    return newID;
}

bool powe::WorldEntity::IsGameObjectExist(EntityID id) const
{
    return m_GameObjectRecords.contains(id);
}

void powe::WorldEntity::RemoveComponentByID(EntityID id, ComponentTypeID componentID)
{
...
void powe::WorldEntity::RemoveGameObject(EntityID id, bool removeRecord)
{
    GameObjectRecord gbRecords{};
    if (GetGameObjectRecords(id, gbRecords))
    {
...
SharedPtr<powe::Archetype> powe::WorldEntity::GetArchetypeByGameObject(EntityID id) const
{
...
void powe::WorldEntity::InternalRemoveGameObjectFromPipeline()
{
    ...
    for (const auto& tobeRemoveGameObjects : m_PendingDeleteGameObjectsFromArchetype | std::views::values)
    {
        ...
        std::vector<EntityID> gameObjectsIDCopy{};
        ...
        for (const EntityID removeGameObjectID : tobeRemoveGameObjects)
        {
            GameObjectRecord gbRecords{};
        ...
        if (revalidateArchetype)
        {
            ...
            {
                const EntityID nextAliveGameObjectID{revalidateArchetype->GameObjectIds[idx]};
...
void powe::WorldEntity::AddGameObjectToRecordRemoveList(EntityID id)
{
    if (m_GameObjectRecords.contains(id))
    {
...
void powe::WorldEntity::AddGameObjectToArchetypeRemoveList(const std::string& archetypeKey, EntityID id)
{
...
void powe::WorldEntity::AddComponentToGameObjectRemoveList(EntityID id, ComponentTypeID componentTypeID)
{
...
void powe::WorldEntity::AddPreArchetype(EntityID gameObjectID,
...
void powe::WorldEntity::RemoveComponentFromPreArchetype(EntityID id, ComponentTypeID componentTypeId)
{
...
void powe::WorldEntity::RemoveGameObjectFromPreArchetype(EntityID id)
{
...
void powe::WorldEntity::DestroyAllComponentDataInGameObject(
    const Archetype& archetype, int index, EntityID id,
...
bool powe::WorldEntity::GetGameObjectRecords(EntityID id, GameObjectRecord& outRecord) const
{
    if (m_GameObjectRecords.contains(id))
    {
...
powe::GameObjectRecord& powe::WorldEntity::GetRefGameObjectRecord(EntityID id)
{
    return m_GameObjectRecords.at(id);
}

bool powe::WorldEntity::GetPreArchetypeTrait(EntityID id, PreArchetypeTrait& outTrait) const
{
    if (m_PreArchetypes.contains(id))
    {
