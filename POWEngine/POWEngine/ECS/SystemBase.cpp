...
// void powe::SystemBase::Draw(const Window& window, const Archetype& archetype)
// {
//     m_UpdateCountPerArchetype = 0;
//     m_CurrentArchetype = &archetype;
//
...
// void powe::SystemBase::Initialize(WorldEntity& worldEntity, const Archetype& archetype)
// {
//     ECSSystemBackend::Initialize(worldEntity, archetype);
//     OnCreate(); // user create
//
//     try
//     {
//         for (const auto gameObjectId : archetype.GameObjectIds)
...
// void powe::SystemBase::Draw(const Window& window, const Archetype& archetype, const RenderAPI& renderAPI)
// {
//     m_UpdateCountPerArchetype = 0;
//     m_CurrentArchetype = &archetype;
//
...
//         {
//             // OnUpdate(deltaTime, gameObjectId);
//             CastDraw(window,renderAPI,gameObjectId);
//             ++m_UpdateCountPerArchetype;
//         }
//     }
//     catch (const std::exception& e)
...
//         auto& sparseManager{GetWorld().GetSparseComponentManager()};
//
