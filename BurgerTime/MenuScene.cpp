...
void MenuScene::LoadScene(powe::WorldEntity& worldEntity)
{
	...
	banner1->AddComponent(AudioComponent{ "./Resources/Sound/Jump.wav" }, ComponentFlag::Sparse);
	...
	banner2->AddComponent(AudioComponent{ "./Resources/Sound/Jump.wav" }, ComponentFlag::Sparse);
